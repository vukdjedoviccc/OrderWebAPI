...
public class OrderTests
{
    ...
    {
        // Arrange and act
        var order = new Order.Domain.Model.Order(1, 1, new DateTime(2011, 6, 10), 146890.00M, new List<OrderItem>());
        ...
        decimal totalAmount)
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new Order.Domain.Model.Order(id, customerId, dt, totalAmount, orderItems));
    }
