...
namespace OrderWebAPITest.DomainValidationTests
{
    public class CompanyTests
    {
        ...
        {
            // Arrange and act
            Company company = new Company("Silaris Solutions", "91345287", "Jurija Gagarina14G, Beograd", "0645233699", "silaris@gmail.com", 1);
            
            // Assert
            Assert.NotNull(company);
            Assert.NotEmpty(company.FullName);
            Assert.NotEmpty(company.RegistrationNumber);
            Assert.NotEmpty(company.Adress);
        ...
        {
            // Assert
            Assert.Throws<ArgumentNullException>(() => new Company(fullName, registrationNumber, adress, phoneNumber, email, id));
        }
        ...
        {
            // Assert
            Assert.Throws<ArgumentException>(() => new Company(fullName, registrationNumber, adress, phoneNumber, email, id));
        }
