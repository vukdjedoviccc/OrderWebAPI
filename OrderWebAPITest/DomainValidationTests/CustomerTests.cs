...
namespace OrderWebAPITest.DomainValidationTests
{
    public class CustomerTests
    {
        ...
        {
            // Arrange and act
            Customer customer = new Customer("Jurija Gagarina14G, Beograd", "0645233699", "silaris@gmail.com", 1);

            // Assert
            Assert.NotNull(customer);
            Assert.NotEmpty(customer.Adress);
            Assert.NotEmpty(customer.PhoneNumber);
            Assert.NotEmpty(customer.Email);
            Assert.NotNull(customer.Adress);
        ...
        [Theory]
        [InlineData("Jurija Gagarina14G, Beograd dsahdlasdasdasjdashdakjeqoiufsabdasalalak", "0652193578", "test@gmail.com", 12)]
        ...
        [Theory]
        [InlineData("Jurija Gagarina14G, Beograd", "0652193578123", "test1234567890qwertyutnovnfifzdssdvsusbsusb@gmail.com", 12)]
